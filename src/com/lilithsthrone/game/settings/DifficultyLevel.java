...
public enum DifficultyLevel {
	...
	LEVEL_SCALING("Morph", "Enemies level up alongside your character, but do normal damage.", Colour.BASE_VIOLET, true, 1, 1),
	
	HARD("Half-Demon", "Enemies do 200% damage.", Colour.BASE_PURPLE_LIGHT, false, 2, 1),

	HARD_SCALING("Demon", "Enemies level up alongside your character and do 200% damage.", Colour.BASE_PURPLE, true, 2, 1),

	NIGHTMARE("Lilin", "Enemies do 200% damage, and take only 50% damage from all sources.", Colour.BASE_LILAC, true, 2, 0.5f),
	
	NIGHTMARE_SCALING("Elder Lilin", "Enemies level up alongside your character, do 200% damage, and take only 50% damage from all sources.", Colour.BASE_RED, false, 2, 0.5f),	
